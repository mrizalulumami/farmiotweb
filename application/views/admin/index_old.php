...
<div class="card bx-shadow" style="margin-top:10px;">
    <div class="card-body">
        <h4 class="m-0">Total Device by Month</h4>
        ...
        <div class="container mt-5 px-2">
            ...
            <div class="mb-2 d-flex justify-content-between align-items-center">
                ...
                <div class="position-relative">
                    <span class="position-absolute search-table"><i class="fa fa-search"></i></span>
                ...
                <table class="table table-responsive table-borderless">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>12</td>
                            <td><img src="<?= base_url('assets/');?>assets/image/tab-1.png" width="25"> Althan Travis
                            </td>
                            <td>1 Oct, 21</td>
                            <td>Wirecard for figma</td>
                            <td><i class="fa fa-check-circle-o green"></i><span class="ms-1">Paid</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th scope="row"><input class="form-check-input" type="checkbox"></th>
                            <td>14</td>
                            <td><img src="<?= base_url('assets/');?>assets/image/tab-2.png" width="25"> Tomo arvis</td>
                            <td>12 Oct, 21</td>
                            <td>Altroz furry</td>
                        ...
                        <tr>
                            <th scope="row"><input class="form-check-input" type="checkbox"></th>
                            <td>90</td>
                            <td><img src="<?= base_url('assets/');?>assets/image/tab-2.png" width="25"> Travis head</td>
                            <td>19 Oct, 21</td>
